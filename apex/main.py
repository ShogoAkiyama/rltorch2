...
from apex.actor import actor_process
from apex.learner import learner_process
...
def run():
    ...
    parser.add_argument('-actor_load_model', type=int, default=100)
    parser.add_argument('-actor_save_log', type=int, default=100)

    parser.add_argument('-learner_eval', type=int, default=1000)
    parser.add_argument('-learner_load_memory', type=int, default=100)
    parser.add_argument('-learner_save_model', type=int, default=100)
    parser.add_argument('-learner_target_update', type=int, default=2500)
    parser.add_argument('-learner_save_log', type=int, default=1)

    parser.add_argument('-lr', type=float, default=2.5e-4/4)
