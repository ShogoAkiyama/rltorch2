...
if __name__ == "__main__":
    ...
    # モデルの作成
    agent.model = Network.value_distribution_network(state_size, num_atoms, action_size, agent.learning_rate)
    agent.target_model = Network.value_distribution_network(state_size, num_atoms, action_size, agent.learning_rate)
