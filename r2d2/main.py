...
def run():
    ...
    parser.add_argument('-actor_save_memory', type=int, default=10)
    ...
    parser.add_argument('-learner_load_memory', type=int, default=10)
    parser.add_argument('-learner_save_model', type=int, default=100)
    parser.add_argument('-learner_target_update', type=int, default=1000)
